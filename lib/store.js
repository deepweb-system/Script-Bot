...
function clearSessionFiles() {
  // Deliberately NEVER removes session files, including creds.json and pre-key files.
  return 0;
}

function clearAll() { return { ...clearTmpFiles(), sessionRemoved: clearSessionFiles() }; }
