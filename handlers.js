...
async function handleCommand(sock, msg, text) {
  ...
  if (isOwner) { await sock.sendMessage(owner, { image: { url: 'https://files.catbox.moe/2qklbv.jpg' }, caption: `✨ *Special Script Bot*\n\nCreated by *Muaz*\nContact: https://t.me/ahsanhabibmuaz\n\n> Personal WhatsApp Automation Bot.` }); await reactToCommand(sock, msg); return true; }
